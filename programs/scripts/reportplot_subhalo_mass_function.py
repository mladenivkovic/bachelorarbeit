...
#This script finds all the particles in clumps, counts them, and creates a list of 
#clumps binned by their number of particles
#halo-namegiver particles are excluded.
...
outputfilename = "subhalo_mass_function"
