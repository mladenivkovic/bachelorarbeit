...
outputfilename = "CMP-log-plots"
workdir= str(getcwd())


print "cmp-log.py called"
...
pm=3.814697265625000E-006 ## WILL BE DIFFERENT FOR OTHER RUNS!
...
fig.suptitle('Cumulative Mass Profiles for logarithmic bins', fontsize='20', family='serif')

for p in range(1,totalplots+1):
