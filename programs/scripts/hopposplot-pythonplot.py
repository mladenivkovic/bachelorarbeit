...
# This script is called by the hopposplot script and will create a graph of the hop .pos file with approximated halo sizes.
...
def extract_ascii(filename):
    ...
    awk_callmap = ['awk', ' NR >= 2 { print $5 } ', getcwd()+'/'+filename]
...
#    ax.set_clip_on(True)
    ...
    ax.set_title(title, size=30, y=1.02,  family='serif')
